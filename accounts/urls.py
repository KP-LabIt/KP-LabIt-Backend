...
urlpatterns = [
    ...
    # Ten link by mal vyzerat nejako takto -> <frontend_url>#/username-reset/<uid>/<token>. Na tejto page treba zadat nové heslo. Potom sa pošle request na ten druhy endpoint.
